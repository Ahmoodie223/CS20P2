...
public class UseButtonAndLED {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(true){
            ...
            if(greenButton.getState()){
                greenLED.setState(true);  // Turn on the green LED when the green button is pressed
            } else {
                greenLED.setState(false);  // Turn off the green LED when the green button is released
            }
